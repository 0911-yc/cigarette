<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="部门状态" min-width="150px">
        <template slot-scope="{row}">
          <span class="link-type">{{ row.departmentstate }}</span>
        </template>
      </el-table-column>
      <!--     自定义列-->
    ...
    <el-dialog :title="title" :visible.sync="dialogFormVisible" style="width: 80%">
      ...
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="70px" style="width: 80%; margin-left:50px;">
        ...
        <el-form-item label="部门名称" prop="departmentName">
          <el-input placeholder="请输入用户名" v-model="temp.departmentname" />
        </el-form-item>
        <el-form-item label="负责人名称" prop="departmentHead">
          <el-input placeholder="请输入密码" v-model="temp.departmenthead" show-password></el-input>
        </el-form-item>
