    ...
    <el-dialog :title="title" :fullscreen="true" :visible.sync="dialogFormVisible" style="width: 80%">
      ...
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="70px"
        ...
        <el-form-item label="标题" prop="title">
          <el-input :disabled="bt" placeholder="请输入标题" v-model="temp.title"></el-input>
        </el-form-item>
        <el-form-item label="内容" prop="content">
          <!--          <VueUE v-model="temp.content" label-width="800px"></VueUE>-->
          <el-card style="height: 610px;">
            <quill-editor :disabled="nr" v-model="temp.content" ref="myQuillEditor" style="height: 500px;"
                          :options="editorOption">
            </quill-editor>
          </el-card>
        </el-form-item>
        <el-form-item label="创建者" prop="creator">
          <el-input :disabled="cjz" readonly placeholder="请输入创建者"
                    v-model="temp.creator = this.$store.state.user.name"></el-input>
        </el-form-item>
<!--        <el-form-item label="状态" prop="status">-->
<!--&lt;!&ndash;          <el-select :disabled="zt" v-model="temp.statuse" placeholder="请选择">&ndash;&gt;-->
<!--&lt;!&ndash;            <el-option&ndash;&gt;-->
<!--&lt;!&ndash;              v-for="item in deptList"&ndash;&gt;-->
<!--&lt;!&ndash;              :key="item.id"&ndash;&gt;-->
<!--&lt;!&ndash;              :label="item.status"&ndash;&gt;-->
<!--&lt;!&ndash;              :value="item.id"></el-option>&ndash;&gt;-->
<!--&lt;!&ndash;         </el-select>&ndash;&gt;-->
<!--          <el-input :disabled="zt" readonly-->
<!--                    v-model="temp.creator = this.$store.state.user.name"></el-input>-->
<!--        </el-form-item>-->
      </el-form>
      <div slot="footer" class="dialog-footer">
        <el-button icon="el-icon-right" @click="dialogFormVisible = false">
          返回
        </el-button>
        <el-button icon="el-icon-success" type="success" @click="dialogStatus==='create'?createData():updateData()">
          保存
        </el-button>
        <el-button icon="el-icon-zoom-in" type="success" @click="check">
          提交审核
        </el-button>
      </div>
    </el-dialog>
