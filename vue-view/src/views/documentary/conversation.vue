<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="谈话类型" min-width="150px">
      ...
      <el-table-column label="谈话时间" width="150px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.talkcreationTime | parseTime('{y}-{m}-{d} {h}:{i}') }}</span>
        </template>
      </el-table-column>

      <el-table-column label="谈话地点" min-width="150px">
        <template slot-scope="{row}">
    ...
    -->
    <el-dialog :title="talkType" :visible.sync="dialogFormVisible" style="width: 80%">
      <!--
          rules:校验规则
          model:数据绑定
      -->
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="70px"
        ...
        <el-form-item label="谈话类型" prop="talkType">
          <el-input placeholder="请输入谈话类型" v-model="temp.talkType"></el-input>
        </el-form-item>
