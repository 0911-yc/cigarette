<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="投稿人" width="150px" align="center">
        <template slot-scope="scope">
          <span>{{scope.row.contributor}}</span>
        </template>
      </el-table-column>
...
<script>
  ...
  import {conList,delList} from "../../api/sys/contribute";
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        ...
        // debugger // 调试
        conList(this.listQuery).then(response => {
