<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="listQuery.postname" placeholder="用户名" style="width: 200px;" class="filter-item"/>
    ...
    >
      ...
      <el-table-column label="岗位编号" width="150px" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column label="岗位状态" min-width="150px">
        <template slot-scope="{row}">
          <span class="link-type">{{ row.poststatus }}</span>
        </template>
      </el-table-column>
      <!--     自定义列-->
    ...
    <el-dialog :title="title" :visible.sync="dialogFormVisible" style="width: 80%">
      ...
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="70px" style="width: 80%; margin-left:50px;">
        ...
        <el-form-item label="岗位名称" prop="postname">
          <el-input placeholder="请输入岗位名称" v-model="temp.postname" />
        </el-form-item>
        <el-form-item label="岗位状态" prop="password">
          <el-input placeholder="请输入岗位状态" v-model="temp.poststatus" ></el-input>
        </el-form-item>
      </el-form>
...
<script>
  import { add, update, list, deleteUser } from '@/api/sys/post'
