<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="listQuery.departmenthead" placeholder="用户名" style="width: 200px;" class="filter-item"/>
    ...
    >
      ...
      <el-table-column label="部门负责人" width="150px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.departmenthead  }}</span>
        </template>
      </el-table-column>

      <el-table-column label="分管领导" width="150px" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column label="部门编号" min-width="150px">
        <template slot-scope="{row}">
          <span class="link-type">{{row.departmentid}}</span>
        </template>
      </el-table-column>
      <!--     自定义列-->
    ...
    <el-dialog :title="title" :visible.sync="dialogFormVisible" style="width: 80%">
      ...
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="70px" style="width: 80%; margin-left:50px;">
        ...
        <el-form-item label="部门名称" prop="departmentname">
          <el-input placeholder="请输入部门名" v-model="temp.departmentname" />
        </el-form-item>
        <el-form-item label="部门编号" prop="departmentname">
          <el-input placeholder="请输入部门编号" v-model="temp.departmentid" />
        </el-form-item>
        <el-form-item label="负责人名称" prop="departmenthead">
          <el-input placeholder="请输入负责人" v-model="temp.departmenthead"></el-input>
        </el-form-item>
