<template>
  <div class="app-container">
    <div class="filter-container">
      标题<el-input v-model="listQuery.title" placeholder="请输入制度流程标题" style="width: 200px;" class="filter-item"/>
      内容<el-input v-model="listQuery.content" placeholder="请输入制度流程内容" style="width: 200px;" class="filter-item"/>
    ...
    >
      ...
      <el-table-column label="制度信息标题" min-width="150px">
...
<script>
  //
  import { add, update, list, deleteUser } from '@/api/sys/sysprocess'
